export const mirrorNodeKeys = {
  account: {
    ...
    balances: (network: string, id: string) =>
      ["mirror-node", network, "account", "balances", id] as const,
    tokens: (network: string, id: string) =>
      ["mirror-node", network, "account", "tokens", id] as const,
    nfts: (network: string, id: string) => ["mirror-node", network, "account", "nfts", id] as const,
    stakingRewards: (network: string, id: string) =>
      ["mirror-node", network, "account", "rewards", id] as const,
    cryptoAllowances: (network: string, id: string) =>
      ["mirror-node", network, "account", "allowances", "crypto", id] as const,
    tokenAllowances: (network: string, id: string) =>
      ["mirror-node", network, "account", "allowances", "token", id] as const,
    nftAllowances: (network: string, id: string) =>
      ["mirror-node", network, "account", "allowances", "nft", id] as const,
    outstandingAirdrops: (network: string, id: string) =>
      ["mirror-node", network, "account", "airdrops", "outstanding", id] as const,
    pendingAirdrops: (network: string, id: string) =>
      ["mirror-node", network, "account", "airdrops", "pending", id] as const,
  ...
  contract: {
    info: (network: string, id: string) =>
      ["mirror-node", network, "contract", "info", id] as const,
    results: (network: string, id: string) =>
      ["mirror-node", network, "contract", "results", id] as const,
    result: (network: string, id: string, timestamp: string) =>
      ["mirror-node", network, "contract", "result", id, timestamp] as const,
    state: (network: string, id: string) =>
      ["mirror-node", network, "contract", "state", id] as const,
    logs: (network: string, id: string) =>
      ["mirror-node", network, "contract", "logs", id] as const,
    allResults: (network: string) =>
      ["mirror-node", network, "contract", "results", "all"] as const,
    resultByTx: (network: string, txHash: string) =>
      ["mirror-node", network, "contract", "results", "byTx", txHash] as const,
    ...
    allLogs: (network: string) =>
      ["mirror-node", network, "contract", "results", "logs", "all"] as const,
  ...
  transaction: {
    info: (network: string, id: string) =>
      ["mirror-node", network, "transaction", "info", id] as const,
    byAccount: (network: string, id: string) =>
      ["mirror-node", network, "transaction", "account", id] as const,
  ...
  topic: {
    ...
    messages: (network: string, id: string) =>
      ["mirror-node", network, "topic", "messages", id] as const,
  ...
  schedule: {
    info: (network: string, id: string) =>
      ["mirror-node", network, "schedule", "info", id] as const,
    list: (network: string) => ["mirror-node", network, "schedules", "list"] as const,
  },
  network: {
    exchangeRate: (network: string) =>
      ["mirror-node", network, "network", "exchange-rate"] as const,
  ...
  block: {
    ...
    info: (network: string, hashOrNumber: string) =>
      ["mirror-node", network, "block", "info", hashOrNumber] as const,
  },
};
