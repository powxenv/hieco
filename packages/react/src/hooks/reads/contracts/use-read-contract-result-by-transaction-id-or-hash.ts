...
export type UseReadContractResultByTransactionIdOrHashOptions<TData = QueryFnData> = HiecoQueryOptions<QueryFnData, TData>;
...
export function useReadContractResultByTransactionIdOrHash<TData = QueryFnData>(
  ...
  return useHiecoQuery({
    ...
    queryFn: () => client.reads.contracts.resultByTransactionIdOrHash(transactionIdOrHash, params).now(),
    options,
  });
}
