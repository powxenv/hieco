...
export type UseReadTopicsListOptions<TData = QueryFnData> = HiecoQueryOptions<QueryFnData, TData>;
...
export function useReadTopicsList<TData = QueryFnData>(
  ...
  return useHiecoQuery({
    operationName: "reads.topics.list",
    args: [params],
    queryFn: () => client.reads.topics.list(params).now(),
    options,
  });
}
