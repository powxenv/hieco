...
# pnpm
pnpm add @hiecom/mirror-js @hiecom/mirror-preact @tanstack/preact-query
...
import { MirrorNodeProvider, createNetworkConfig } from "@hiecom/mirror-preact";
...
```tsx
import { useAccountInfo } from "@hiecom/mirror-preact";
