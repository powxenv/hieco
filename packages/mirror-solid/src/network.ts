...
type CreateNetworkExchangeRateResult = UseQueryResult<ApiResult<ExchangeRate>, ApiError>;

export interface CreateNetworkFeesOptions {
  readonly enabled?: boolean;
}

type CreateNetworkFeesResult = UseQueryResult<ApiResult<NetworkFee>, ApiError>;

export interface CreateNetworkNodesOptions {
  readonly enabled?: boolean;
}

type CreateNetworkNodesResult = UseQueryResult<ApiResult<NetworkNode[]>, ApiError>;

export interface CreateNetworkStakeOptions {
  readonly enabled?: boolean;
}

type CreateNetworkStakeResult = UseQueryResult<ApiResult<NetworkStake>, ApiError>;

export interface CreateNetworkSupplyOptions {
  readonly enabled?: boolean;
}

type CreateNetworkSupplyResult = UseQueryResult<ApiResult<NetworkSupply>, ApiError>;
