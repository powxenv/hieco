...
type CreateTokenInfoResult = UseQueryResult<ApiResult<TokenInfo>, ApiError>;
...
type CreateTokenBalancesResult = UseQueryResult<ApiResult<TokenDistribution[]>, ApiError>;
...
type CreateTokenBalancesSnapshotResult = UseQueryResult<ApiResult<TokenBalancesResponse>, ApiError>;
...
type CreateTokenNftsResult = UseQueryResult<ApiResult<PaginatedResponse<Nft>>, ApiError>;
...
type CreateTokenNftResult = UseQueryResult<ApiResult<Nft>, ApiError>;
...
type CreateTokenNftTransactionsResult = UseQueryResult<ApiResult<Transaction[]>, ApiError>;
...
type CreateTokensResult = UseQueryResult<ApiResult<TokenInfo[]>, ApiError>;
...
type CreateTokensInfiniteResult = UseInfiniteQueryResult<
