...
type UseTokenInfoResult = UseQueryResult<ApiResult<TokenInfo>, ApiError>;
...
type UseTokenBalancesResult = UseQueryResult<ApiResult<TokenDistribution[]>, ApiError>;
...
type UseTokenBalancesSnapshotResult = UseQueryResult<ApiResult<TokenBalancesResponse>, ApiError>;
...
type UseTokenNftsResult = UseQueryResult<ApiResult<PaginatedResponse<Nft>>, ApiError>;
...
type UseTokenNftResult = UseQueryResult<ApiResult<Nft>, ApiError>;
...
type UseTokenNftTransactionsResult = UseQueryResult<ApiResult<Transaction[]>, ApiError>;
...
type UseTokensResult = UseQueryResult<ApiResult<TokenInfo[]>, ApiError>;
...
type UseTokensInfiniteResult = UseInfiniteQueryResult<
