  ...
  return (
    <>
      <div className="h-60 relative">
        <img className="absolute size-full object-cover object-top" src={heroImg} />
      ...
      <section className="relative">
        <div className="inner">
          ...
          <p className="text-xl max-w-md my-4">
            Discover projects yang dibuat di hedera network dan dibuat menggunakan ekosistem hiero
            dan hieco.
          </p>
          ...
          <div className="flex gap-2 mt-4">
            ...
            <Field orientation="horizontal" className="w-fit">
              ...
              <FieldLabel htmlFor="switch-disabled-unchecked">Open Source</FieldLabel>
            </Field>
            {session && (
              <Field orientation="horizontal" className="w-fit">
                <Switch id="switch-disabled-unchecked" />
                <FieldLabel htmlFor="switch-disabled-unchecked">Hide Yours</FieldLabel>
              </Field>
            )}
          </div>
        </div>
          ...
          <div className="grid grid-cols-3 gap-4">
            <div>
              <div className="aspect-video rounded-xl overflow-hidden">
                <img src="https://picsum.photos/1600/900" className="object-cover size-full" />
              </div>
