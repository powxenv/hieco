...
| App that already uses Reown AppKit and needs compatibility | main SDK skill                           | The AppKit bridge belongs to `@hieco/react`, not the wallet family.                                  |
...
| App using Reown AppKit     | main SDK skill                           | `@hieco/react/appkit` is documented with the main SDK surface             |
